...
export default function TalknightPage() {
  return (
    <div className='transition-all duration-1000'>
        <div className="rounded-b-full pb-20 lg:pb-80 bg-indigo-100  lg:flex flex-row-reverse pt-20  lg:pt-40 ">
     <div className="pr-5 pb-5 pl-5">
      ...
      <div className="lg:pt-10 pl-5 lg:pl-20 pr-5 lg:pr-20 grid justify-center block">
        ...
        <div className=''>
        <h1 className="text-gray-700 text-2xl mb-10">
        ...
        <div className='flex'>
        <h1 className="text-gray-700 text-1xl font-bold">
        This week: 
        </h1>
        <h1 className='link link-underline link-underline-black text-gray-700 text-md '>
