...
export default function Intro() {
  return (
    ...
    <div className=" pt-20 pb-20 ">
        ...
        <div className="  space-x-2 lg:space-x-3 lg:flex" >
            <div> 
                ...
                <div className='pt-2'>
           <button className="transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300 inline-block px-6 py-2 border-2 border-gray-100 text-gray-50 font-medium text-xs leading-tight uppercase rounded hover:bg-red-700 hover:bg-opacity-5 focus:outline-none focus:ring-0 transition duration-150 ease-in-out" >watch Live stream </button>
           </div>
           </Link>
