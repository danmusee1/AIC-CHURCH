...
export default function LivePage() {
  return (
    <div>
        <div className="lg:flex flex-row-reverse pt-20  lg:pt-40">
     <div className="pr-5 pb-5 pl-5">
      ...
      <div className="lg:pt-10 pl-5 lg:pl-20 pr-5 lg:pr-20 grid justify-center block">
        ...
        <div>
        <button className="py-2 px-4 bg-blue-500 text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-opacity-75 text-gray-900 text-1xl font-bold mb-2">connect with us</button>
        </div>
      </div>
