...
export default function MailCheck() {
  return (
    <div className="pt-20 pb-20 lg:pl-20 pl-5 pr-5">
        ...
        <h1 className='text-green-700  text-2xl lg:text-3xl font-bold mb-2'>
        Donate using Mpesa
           </h1>
        <h1 className='lg:w-2/3 text-green-600 text-lg pb-5'> 
        If youd prefer to make a donation via c online bill number,
        </h1>
        <div className=''>
            <div className='flex'>
...
Umoja 1 Nairobi, Kenya
        ...
        <div className=''>
          ...
          <Image className="" src="https://352zl3r81ot2rnkzo1r0n6uj-wpengine.netdna-ssl.com/wp-content/uploads/2021/07/stock-stock.jpeg" alt="image" height="500" width="700"/>
          </div>
        </div>
    </div>
  )
