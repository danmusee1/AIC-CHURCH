  ...
  return (
    ...
    <div id='volunteer_background'className=''>
      ...
      <div className="grid justify-items-center grid pb-5 lg:pb-10  ">
        ...
        <h1 className="lg:w-1/3 text-center pb-5 text-white-700 text-lg font-bold ">Get involved in making the AIC UMJA a better place by participating in our volunteer programs.</h1>
