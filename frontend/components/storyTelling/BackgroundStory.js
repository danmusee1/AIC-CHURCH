...
export default function BackgroundStory() {
    return (
        <div>
        <div className="   ">
        <div id='storytelling_background'className='shapedividers_com-6696 '>
...
Jesus and the Power of </h1>
<h1 className="font-serif grid justify-items-center text-white-900 text-5xl lg:text-7xl font-bold mb-2">
    
                  Storytelling</h1>
            
            </div>
            <h1 className="pb-5 text-gray-400 text-lg font-bold ">A series about the parables of Jesus, and how they make God personal.</h1>
